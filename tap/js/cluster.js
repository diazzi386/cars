...
ui.cluster = {
	...
	onetime: function () {
		...
		context.fillText(car.general.name, w/2, h/2 - 75);
		...
		if (time.chrono.TIME_0200) {
			context.fillStyle = "#3F51B5";
			context.font = FONT(80);
			context.fillText(time.chrono.TIME_0200.toFixed(2), w/2, h/2 + 115);	
		} else if (time.chrono.TIME_0100) {
			context.fillStyle = "#F50057";
			context.font = FONT(80);
			context.fillText(time.chrono.TIME_0100.toFixed(2), w/2, h/2 + 115);	
		}
